...
public class BasicEnemy {
    ...
    // Constructor
    public BasicEnemy(String textureName, World world, Vector2 spawnPoint, MyContactListener contactListener){
    ...
    public BasicEnemy(World world, Vector2 spawnPoint, MyContactListener contactListener){
